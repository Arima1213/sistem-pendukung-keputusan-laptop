                                                ...
                                                <div class='col-6'>
                                                    ...
                                                    <div class='inputData'>
                                                        ...
                                                        <input class="form-control" name="namaLaptop"
                                                            value='<?= $data['NAMA_LAPTOP'] ?>' readonly>
                                                    </div>
                                                </div>
                                                <?php
                                            ...
                                            <div class="inputData row">
                                                ...
                                                <div class='col-6 d-flex'>
                                                    <input class="form-control align-self-end"
                                                        ...
                                                        placeholder='ex. Rp3.xxx.xxx' readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="inputData row">
                                                ...
                                                <div class='col-6 d-flex'>
                                                    <input class="form-control align-self-end "
                                                        ...
                                                        placeholder='ex. 14.7-inch' readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="inputData row">
                                                <div class='col-6'>
                                                    ...
                                                    <input class="form-control align-self-end " type="number"
                                                        name="prosesor" value="<?= $data['VALUE'] ?>" min="0" readonly>
                                                </div>
                                                <div class='col-6 d-flex'>
                                                    <input class="form-control align-self-end "
                                                        value="<?= $data['KETERANGAN'] ?>" name="prosesor_desc"
                                                        placeholder='ex. Intel Core i7 7700HK' readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="inputData row">
                                                ...
                                                <div class='col-6 d-flex'>
                                                    <input class="form-control align-self-end "
                                                        ...
                                                        placeholder='ex. DDR4 2666MHz' readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="inputData row">
                                                ...
                                                <div class='col-6 d-flex'>
                                                    <input class="form-control align-self-end "
                                                        ...
                                                        placeholder='ex. 512GB M.2 NVMe™ PCIe® 3.0 SSD' readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="inputData row">
                                                ...
                                                <div class='col-6 d-flex'>
                                                    <input class="form-control align-self-end "
                                                        ...
                                                        placeholder='ex. Mouse + Steam Wallet' readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
